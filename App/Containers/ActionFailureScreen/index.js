...
function ActionFailureScreen({ onGoBack, navigation }) {
  const header = navigation.getParam('header') || 'Failure';
  const title = navigation.getParam('title') || 'Action Was Not Completed';
  ...
  return (
    ...
    >
      <H1 text={title} icon={Images.closeIcon} />
...
export default compose(withConnect)(ActionFailureScreen);
