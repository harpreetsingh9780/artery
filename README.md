...
### Android
    ...
    cd android
    fastline debug_apk   # builds apk for debuging in /android/app/build/outputs/apk/debug/app-debug.apk
    fastline release_apk # builds apk for release in /android/app/build/outputs/apk/release/app-release.apk
...
- create your [configuration file `App/Config/LoginScreen.js`](App/Config) from `index.dev.js` (if you are in dev environment) and fill the missing values
